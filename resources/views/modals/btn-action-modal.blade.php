<div class="btn-group action_btn relative" style="position: relative">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <button href="{{ @$edit }}" class="btn btn-xs btn-primary btn-flat btn-edit" data-id="{{$id}}"
                    data-detail="{{$detail}}" data-url="{{$urlEdit}}" data-toggle="modal"><i
                        class="glyphicon glyphicon-edit"></i> Sửa
            </button>
        </li>
        <li>
            <button class="btn btn-xs btn-danger btn-flat list-item-delete-btn"
                    data-url="{{ @$destroy }}"><i
                        class="glyphicon glyphicon-trash"></i> Xóa
            </button>
        </li>
    </ul>
</div>
